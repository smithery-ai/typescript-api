...
describe('resource votes', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.skills.votes.create('slug', { namespace: 'namespace', isPositive: true });
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.skills.votes.create('slug', { namespace: 'namespace', isPositive: true });
  });
